      ...
      def self.included(klass)
        klass.class_eval do
          ...
          def self.define_state_machine!
            ...
            state_machine :state, :initial => :pax, :use_transactions => false, :action => :save_state do
              ...
              before_transition :to => :pax, :do => :ensure_line_items_present
              ...
              after_transition :from => any - :pax, :to => any - [:confirm, :complete] do |order|
                order.update_totals
